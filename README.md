...
![Language](https://img.shields.io/badge/Language-Python-3776AB?style=flat-square) ![Stars](https://img.shields.io/github/stars/Devanik21/AI-Video-Insights?style=flat-square&color=yellow) ![Forks](https://img.shields.io/github/forks/Devanik21/AI-Video-Insights?style=flat-square&color=blue) ![Author](https://img.shields.io/badge/Author-Devanik21-black?style=flat-square&logo=github) ![Status](https://img.shields.io/badge/Status-Active-brightgreen?style=flat-square)

> AI Video Insights — an intelligent, interactive ML application built for real-world prediction and analysis.

---

**Topics:** `computer-vision` · `content-summarization` · `deep-learning` · `generative-ai` · `large-language-models` · `multimodal-ai` · `nlp` · `temporal-grounding` · `video-understanding` · `youtube-transcript-analysis`

## Overview

AI Video Insights is a machine learning web application built on Streamlit that provides a clean, accessible interface for a trained predictive model. The application takes structured user input, preprocesses it through a scikit-learn Pipeline, and returns model predictions with confidence scores and explanatory visualisations.
...
> **Key packages detected in this repo:** `streamlit` · `google-generativeai` · `moviepy` · `gTTS` · `pydub` · `whisper` · `pytube` · `yt-dlp` · `requests`
...
```bash
git clone https://github.com/Devanik21/AI-Video-Insights.git
